...
class StringSet {
     ...
     */
    public static getSeriesByBrandAndType(brand: string, type: string) {
     ...
     */
    public static getDefaultStrings(): StringInfo[] {
        return [
     ...
     * @returns An array of StringInfo objects.
     */
    public static getDAddarioEXL120SuperLight(): StringInfo[] {
        return [
     ...
     * @returns An array of StringInfo objects.
     */
    public static getDAddarioEXL120SuperLightPlus(): StringInfo[] {
        return [
     ...
     * @returns An array of StringInfo objects.
     */
    public static getDAddarioXEL115MediumElectric(): StringInfo[] {
        return [
            this.getSeriesByBrandAndType("D'Addario", "Plain Steel").getStringByGauge(0.011),
