...
class StringTable {
    constructor() {
        ...
        this.defaultStrings = [];
        this.currentStrings = [];
        this.defaultStrings[0] = new stringstate_js_1.StringState(64, 25.5, utilities_js_1.Utilities.getStringWeightTablePL().getStringByGauge(0.01));
        this.defaultStrings[1] = new stringstate_js_1.StringState(59, 25.5, utilities_js_1.Utilities.getStringWeightTablePL().getStringByGauge(0.013));
        this.defaultStrings[2] = new stringstate_js_1.StringState(55, 25.5, utilities_js_1.Utilities.getStringWeightTablePL().getStringByGauge(0.017));
        this.defaultStrings[3] = new stringstate_js_1.StringState(50, 25.5, utilities_js_1.Utilities.getStringWeightTableNW().getStringByGauge(0.026));
        this.defaultStrings[4] = new stringstate_js_1.StringState(45, 25.5, utilities_js_1.Utilities.getStringWeightTableNW().getStringByGauge(0.036));
        this.defaultStrings[5] = new stringstate_js_1.StringState(40, 25.5, utilities_js_1.Utilities.getStringWeightTableNW().getStringByGauge(0.046));
        this.defaultStrings[6] = new stringstate_js_1.StringState(35, 25.5, utilities_js_1.Utilities.getStringWeightTableNW().getStringByGauge(0.059));
        this.defaultStrings[7] = new stringstate_js_1.StringState(30, 25.5, utilities_js_1.Utilities.getStringWeightTableNW().getStringByGauge(0.074));
        for (let i = 0; i < 6; i++) {
            this.currentStrings[i] = new stringstate_js_1.StringState(this.defaultStrings[i].note, this.defaultStrings[i].scale, this.defaultStrings[i].stringInfo);
        }
    }
    /**
